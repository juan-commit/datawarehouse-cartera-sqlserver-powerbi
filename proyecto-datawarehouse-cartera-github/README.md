...
El objetivo del proyecto es transformar datos operativos de facturación, pagos y notas de crédito en un modelo analítico que permita evaluar saldos pendientes, comportamiento de clientes, zonas, vendedores y evolución de la cartera en el tiempo.
